...
namespace AbpLteDemo.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AbpLteDemoDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AbpLteDemoEfCoreEntityExtensionMappings to extend the IdentityUser entity
